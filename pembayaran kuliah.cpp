...
cout << endl;
    ...
    cout << "===============================================\n" << endl; 
   cout << " Total SPP Yang Harus Di bayarkan.   Rp. 2400000  "<<endl;
   cout << " Total SPB Yang Harus Di bayarkan.   Rp. 1800000  "<<endl;
   cout << endl;
    ...
    while (selesai == false) { 
        ...
        if (pilih[i]==0) { 
            ...
            switch (pilih[i]) {
                case 1 : menu[i] = "SPP ";harga[i] = 400000;
                break;
                case 2 : menu[i] = "SPb ";harga[i] = 50000;
                break;
